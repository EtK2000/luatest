...
local REPO_PREFIX = 'https://raw.githubusercontent.com/EtK2000/Alb-no-OS/master/'
local URL = os.readOnly({
	['core'] = REPO_PREFIX .. 'core', -- the startup file
	['modules'] = REPO_PREFIX .. 'modules', -- the modules index
	['version'] = REPO_PREFIX .. 'version' -- the current version
})
